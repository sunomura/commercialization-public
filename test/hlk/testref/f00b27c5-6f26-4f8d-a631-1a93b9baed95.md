---
title: UCSI USB Operation Mode command - UFP to DRP connection
description: UCSI USB Operation Mode command - UFP to DRP connection
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: e2c38e39-67ff-4459-ae02-d8202b553067
---

# <span id="p_hlk_test.f00b27c5-6f26-4f8d-a631-1a93b9baed95"></span>UCSI USB Operation Mode command - UFP to DRP connection


Sets the UCSI USB Operation Mode of the system to UFP and the partner to DRP and confirms that a connection is established.
