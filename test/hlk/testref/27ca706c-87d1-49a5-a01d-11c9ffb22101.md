---
title: UCSI Power Direction Mode command - Consumer
description: UCSI Power Direction Mode command - Consumer
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 35dbc6ac-a11c-4084-9399-fa9f8615cad0
---

# <span id="p_hlk_test.27ca706c-87d1-49a5-a01d-11c9ffb22101"></span>UCSI Power Direction Mode command - Consumer


Verifies that the system supports the UCSI Set Power Direction Mode command to set a connector to Consumer mode.
