---
title: UCSI Power Direction Mode command - Provider
description: UCSI Power Direction Mode command - Provider
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 769f4807-7d89-4583-98b7-83752b84213e
---

# <span id="p_hlk_test.aabf6e16-86ac-45dc-adc1-312d7997ed52"></span>UCSI Power Direction Mode command - Provider


Verifies that the system supports the UCSI Set Power Direction Mode command to set a connector to Provider mode.
