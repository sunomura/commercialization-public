---
title: UCSI Get Connector Status command - AudioAccessory detection
description: UCSI Get Connector Status command - AudioAccessory detection
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: eb5e8561-b951-46af-bc34-f393cee7d6ca
---

# <span id="p_hlk_test.c3c650ee-8c7f-4ab9-b023-d4380480232c"></span>UCSI Get Connector Status command - AudioAccessory detection


Verifies that the system can detect an AudioAccessory partner.
