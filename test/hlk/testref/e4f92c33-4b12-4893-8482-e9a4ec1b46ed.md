---
title: UCSI USB Operation Mode command - DRP to DRP connection
description: UCSI USB Operation Mode command - DRP to DRP connection
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 3a231cc4-a553-4420-8367-b39c625ddb17
---

# <span id="p_hlk_test.e4f92c33-4b12-4893-8482-e9a4ec1b46ed"></span>UCSI USB Operation Mode command - DRP to DRP connection


Sets the UCSI USB Operation Mode of the system to DRP and the partner to DRP and confirms that a connection is established.
