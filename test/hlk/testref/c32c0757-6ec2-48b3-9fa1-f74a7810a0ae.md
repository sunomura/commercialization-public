---
title: UCSI Power Direction Mode command - Reset on PPM-Reset
description: UCSI Power Direction Mode command - Reset on PPM-Reset
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 6f43bd14-07e6-4b1b-9195-ab6674368d0e
---

# <span id="p_hlk_test.c32c0757-6ec2-48b3-9fa1-f74a7810a0ae"></span>UCSI Power Direction Mode command - Reset on PPM-Reset


Verifies that the Power Direction Mode requested using the UCSI Set Power Direction Mode command is reset on performing a PPM-Reset.
