---
title: UCSI Power Direction Mode command - Provider-Consumer
description: UCSI Power Direction Mode command - Provider-Consumer
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 9c8e5202-f003-4c69-9ea2-bba6d6016db0
---

# <span id="p_hlk_test.e0f75f57-749e-4841-b13d-1185eaa2cd40"></span>UCSI Power Direction Mode command - Provider-Consumer


Verifies that the system supports the UCSI Set Power Direction Mode command to set a connector to Provider-Consumer mode.
