---
title: UCSI USB Operation Mode command - DFP to DRP connection
description: UCSI USB Operation Mode command - DFP to DRP connection
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: 33594224-8a19-4226-8a67-b1936be2ceaf
---

# <span id="p_hlk_test.3cfb9209-57d5-4048-bce9-60834eb62c9f"></span>UCSI USB Operation Mode command - DFP to DRP connection


Sets the UCSI USB Operation Mode of the system to DFP and the partner to DRP and confirms that a connection is established.
