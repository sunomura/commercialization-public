---
title: UCSI Get Connector Status command - DebugAccessory detection
description: UCSI Get Connector Status command - DebugAccessory detection
MSHAttr:
- 'PreferredSiteName:MSDN'
- 'PreferredLib:/library/windows/hardware'
ms.assetid: c22e2e1f-43d5-4480-ab03-d95c297a505e
---

# <span id="p_hlk_test.dc6eae9a-1797-4398-b2e6-ddf3e81fffe3"></span>UCSI Get Connector Status command - DebugAccessory detection


Verifies that the system can detect a DebugAccessory partner.
